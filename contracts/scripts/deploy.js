...
async function main() {
  console.log("🚀 Starting MonadPay Smart Contract Deployment...\n");
  ...
  try {
    ...
    console.log("📦 Step 1: Deploying HandleRegistry...");
    ...
    console.log("📦 Step 2: Deploying Payment contract...");
    ...
    console.log("📦 Step 3: Deploying PaymentRequest contract...");
    ...
    console.log("✅ PaymentRequest deployed to:", paymentRequestAddress);
