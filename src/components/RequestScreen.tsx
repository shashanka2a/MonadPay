        ...
        <div className="flex-1 overflow-y-auto pb-32">
          <div className="flex flex-col items-center justify-center px-6 py-6 min-h-full">
            ...
            <div className="w-full max-w-md space-y-3">
              <button
                onClick={handleShare}
                className="w-full py-4 rounded-full bg-gradient-to-r from-[#836EF9] to-[#4FFFFF] text-white flex items-center justify-center gap-2 hover:opacity-90 transition-opacity shadow-lg"
              >
    ...
    <div className="min-h-screen bg-[#050505] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pb-32">
        ...
        <div className="flex flex-col justify-center px-6 py-6">
          ...
          {/* Numeric Keypad */}
          <div className="grid grid-cols-3 gap-4 max-w-sm mx-auto w-full mb-6">
